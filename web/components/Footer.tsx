          ...
          <div className="lg:col-span-4 xl:col-span-3 flex flex-col items-start">
            ...
            <div className="flex flex-col gap-4 mt-6">
              ...
              <div className="flex items-center gap-3">
                ...
                {/* GitHub */}
                <a href="https://github.com/sheelganvir/1click" target="_blank" rel="noreferrer" className="flex h-[30px] w-[30px] items-center justify-center rounded-full border border-light-accent text-primary hover:bg-[#0B7A2A] hover:text-white hover:border-[#0B7A2A] transition-colors shadow-sm">
